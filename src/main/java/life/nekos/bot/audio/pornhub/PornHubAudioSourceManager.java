...
public class PornHubAudioSourceManager implements AudioSourceManager, HttpConfigurable {
    ...
    private static final String VIDEO_REGEX =
            "^https?://www.pornhub.com/view_video.php\\?viewkey=[a-zA-Z0-9]{9,15}$";
    private static final Pattern VIDEO_INFO_REGEX =
            Pattern.compile("var flashvars_\\d{7,9} = (\\{.+})");
    ...
    private AudioItem loadItemOnce(AudioReference reference) {
        try (HttpInterface httpInterface = getHttpInterface()) {
            ...
            throw ExceptionTools.wrapUnfriendlyExceptions(
                    "Loading information for a PornHub track failed.", FAULT, e);
        }
    }
    ...
    public PornHubAudioTrack buildTrackObject(
            String uri,
            String identifier,
            String title,
            String uploader,
